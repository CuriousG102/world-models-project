...
def collation_fn(rollouts):
    rollouts = [r[0] for r in rollouts]
    return np.concatenate(rollouts, axis=0)

dataset_train = VariableLengthRolloutSequenceDataset(
...
test_loader = torch.utils.data.DataLoader(
    dataset_test, batch_size=args.batch_size, num_workers=2, collate_fn=collation_fn)
